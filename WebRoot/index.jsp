	...
	<div align="center">
		<form name="uploadForm" method="POST" enctype="MULTIPART/FORM-DATA"
			...
			<table>
				...
				<tr>
					<td><div align="left">person_id</div></td>
					<td><input type="text" id="person_id" name="person_id"
						size="20" value="123456" /></td>
				</tr>
				<tr>
					<td><div align="left">telnum</div></td>
				...
				<tr>
					<td><div align="left">policy_number</div></td>
					<td><input type="text" id="policy_number" name="policy_number"
						value="368028201028201" size="20" /></td>
				</tr>
				<tr>
					<td><div align="left">nas_dir</div></td>
					<td><input type="text" id="nas_dir" name="nas_dir" size="20"
						value="/Users/ning/xxx/xx" />
					</td>
				</tr>
				<tr>
					<td><div align="left">response_num</div></td>
					<td><input type="text" id="response_num" name="response_num"
						value="090256789019876" size="20" /></td>
				</tr>
				<tr>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" size="20" name="person_id"
						id="person_id" value="123456" /> <span id="msg"></span>
					</td>
				</tr>
				<tr>
					<td><div align="left">response_num</div></td>
		...
		<form name="uploadForm" method="get" enctype="text/plain"
			...
			<table>
				...
				<tr>
					<td><input type="submit" name="submit" value="query">
					</td>
					<td><input type="reset" name="reset" value="reset"></td>
				</tr>
			</table>
